...
class LFCParams
{
  public:
    ...
    uint32_t getNmPckdROIs_u32(void) const { return numPickedROIs_u32; }
    uint32_t getNmPtchsPrROI_u32(void) const { return numPatchesPerROI_u32; }
    tsc_math::ROISize getPtchSz_t(void) const { return patchSize_t; }
    bool_t getRndmPtchs_b(void) const { return randomPatches_b; }
    uint32_t getDtctnFrmSkp_u32(void) const { return detectionFrameSkip_u32; }
    uint32_t getTrckLngth_u32(void) const { return trackLength_u32; }
    uint32_t getSrchRds_u32(void) const { return searchRadius_u32; }
    uint32_t getTrckrThrsh1_u32(void) const { return trackerThresh1_u32; }
    uint32_t getTrckrThrsh2_u32(void) const { return trackerThresh2_u32; }
    bool_t getTrckUsngMAD_b(void) const { return trackUsingMAD_b; }
    uint32_t getNmROIPls_u32(void) const { return numROIPools_u32; }
    uint32_t getNmROIsPrPl_u32(void) const { return numROIsPerPool_u32; }
    bool_t getCyclThrghROIs_b(void) const { return cycleThroughROIs_b; }

    void putNmPckdROIs_v(uint32_t i_Param_u32) { numPickedROIs_u32 = i_Param_u32; }
    void putNmPtchsPrROI_v(uint32_t i_Param_u32) { numPatchesPerROI_u32 = i_Param_u32; }
    void putPtchSz_v(uint8_t i_ParamW_u8, uint8_t i_ParamH_u8) { patchSize_t.width_s32 = i_ParamW_u8; patchSize_t.height_s32 = i_ParamH_u8; }
    void putRndmPtchs_v(bool_t i_Param_b) { randomPatches_b = i_Param_b; }
    void putDtctnFrmSkp_v(uint32_t i_Param_u32) { detectionFrameSkip_u32 = i_Param_u32; }
    void putTrckLngth_v(uint32_t i_Param_u32) { trackLength_u32 = i_Param_u32; }
    void putSrchRds_v(uint32_t i_Param_u32) { searchRadius_u32 = i_Param_u32; }
    void putTrckThrsh1_v(uint32_t i_Param_u32) { trackerThresh1_u32 = i_Param_u32; }
    void putTrckThrsh2_v(uint32_t i_Param_u32) { trackerThresh2_u32 = i_Param_u32; }
    void putTrckUsngMAD_v(bool_t i_Param_b) { trackUsingMAD_b = i_Param_b; }
    void putNmROIPls_v(uint32_t i_Param_u32) { numROIPools_u32 = i_Param_u32; }
    void putNmROIsPrPl_v(uint32_t i_Param_u32) { numROIsPerPool_u32 = i_Param_u32; }
    void putCyclThrghROIs_v(bool_t i_Param_b) { cycleThroughROIs_b = i_Param_b; }

    mecl::core::ArrayList< uint32_t, tscApi::NUM_SPEED_RANGES > &getspdRngs_rx(void) { return speedRanges_x; }
    mecl::core::ArrayList< uint32_t, tscApi::NUM_SPEED_RANGES > &gettrckngFrmSkps_rx(void) { return trackingFrameSkips_x; }
    mecl::core::Array < tsc_math::ROIRect, tsc_cfg::NUM_AVAILABLE_ROIS> &getavlblROIs_rx(void) { return availableROIs_x; }
    mecl::core::Array < uint32_t, tsc_cfg::NUM_AVAILABLE_ROIS> &getrPrfrmncs_rx(void) { return roiPerformances_x; }
    mecl::core::Array < uint32_t, tsc_cfg::NUM_AVAILABLE_ROIS> *getAddrrPrfrmncs_px(void) { return &roiPerformances_x; }
...
class LocalFeatureCollector
{
    ...
    fc::LocalFeatureTrackCollection *getLocalFeatureTrackCollection_po() {return ( &localTrackList_o );}
